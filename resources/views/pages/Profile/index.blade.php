        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="profile-widget-name">{{ Auth::user()->name }}<div
                    ...
                    <div class="slash"></div>{{ Auth::user()->role ?? 'User Role' }}
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            <div class="profile-widget-header">
                                <img alt="image"
                                    src="{{ asset('img/avatar/profile.jpg') }}"
                            ...
                            <div class="profile-widget-description">
                                <div class="profile-widget-name">Jun Adam<div
                                        class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div>Full Stack Developer
                                    </div>
                                </div>
                                Jun adam is a superhero name in <b>Indonesia</b>, especially in my family. He is not a
                    ...
                    <div class="col-12 col-md-12 col-lg-7">
                        <div class="card">
                            <form method="post"
                                ...
                                novalidate=""><div class="card-header">
                                    <h4>Edit Profile</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
